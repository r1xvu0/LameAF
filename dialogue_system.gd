...
var frame_height : int = 200 # Dialog frame height (in pixels)
...
var frame_margin_vertical : int = 575 # Vertical space (in pixels) between the dialogue box and the window border
...
func set_frame(): # Mostly aligment operations.
	match frame_position:
		'top':
			...
			self.rect_position = Vector2(720, 550)
		'bottom':
			print('bottom')
